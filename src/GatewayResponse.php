...
//
    if (xml_parse_into_struct($parser, $xmlString, $vals, $index) == 0) {
      ...
      $this->SetResults(GatewayCodes__RESPONSE_REQUEST_ERROR,
...
//////////////////////////////////////////////////////////////////////
//
  static function _3DSECURE_DEVICE_COLLECTION_JWT() { return "_3DSECURE_DEVICE_COLLECTION_JWT"; }
  static function _3DSECURE_DEVICE_COLLECTION_URL() { return "_3DSECURE_DEVICE_COLLECTION_URL"; }
  static function _3DSECURE_STEP_UP_URL() { return "_3DSECURE_STEP_UP_URL"; }
  static function _3DSECURE_STEP_UP_JWT() { return "_3DSECURE_STEP_UP_JWT"; }
  static function _3DSECURE_VERSION() { return "_3DSECURE_VERSION"; }
  static function VERSION_INDICATOR() { return "version"; }
  static function ACS_URL() { return "acsURL"; }
  static function AUTH_NO() { return "authNo"; }
  static function AVS_RESPONSE() { return "avsResponse"; }
  static function BALANCE_AMOUNT() { return "balanceAmount"; }
  static function BALANCE_CURRENCY() { return "balanceCurrency"; }
  static function BANK_RESPONSE_CODE() { return "bankResponseCode"; }
  ...
  static function CARD_TYPE() { return "cardType"; }
  static function CARD_HASH() { return "cardHash"; }
  static function CARD_BIN() { return "cardBin"; }
  static function CARD_LAST_FOUR() { return "cardLastFour"; }
  static function CARD_EXPIRATION() { return "cardExpiration"; }
  static function CARD_COUNTRY() { return "cardCountry"; }
  static function CARD_REGION() { return "cardRegion"; }
  static function CARD_DESCRIPTION() { return "cardDescription"; }
  static function CARD_DEBIT_CREDIT() { return "cardDebitCredit"; }
  static function CARD_ISSUER_NAME() { return "cardIssuerName"; }
  static function CARD_ISSUER_PHONE() { return "cardIssuerPhone"; }
  static function CARD_ISSUER_URL() { return "cardIssuerURL"; }
  static function CAVV_RESPONSE() { return "cavvResponse"; }
  static function CUSTOMER_FIRSTNAME() { return "customerFirstName"; }
  static function CUSTOMER_LASTNAME() { return "customerLastName"; }
  static function CVV2_CODE() { return "cvv2Code"; }
  static function EXCEPTION() { return "exception"; }
  static function ECI() { return "ECI"; }
  static function EMAIL() { return "email"; }
  static function IOVATION_TRACKING_NO() { return "IOVATIONTRACKINGNO"; }
  static function IOVATION_DEVICE() { return "IOVATIONDEVICE"; }
  static function IOVATION_RESULTS() { return "IOVATIONRESULTS"; }
  static function IOVATION_SCORE() { return "IOVATIONSCORE"; }
  static function IOVATION_RULE_COUNT() { return "IOVATIONRULECOUNT"; }
  static function IOVATION_RULE_TYPE_() { return "IOVATIONRULETYPE_"; }
  static function IOVATION_RULE_REASON_() { return "IOVATIONRULEREASON_"; }
  static function IOVATION_RULE_SCORE_() { return "IOVATIONRULESCORE_"; }
  static function JOIN_DATE() { return "joinDate"; }
  static function JOIN_AMOUNT() { return "joinAmount"; }
  static function LAST_BILLING_DATE() { return "lastBillingDate"; }
  static function LAST_BILLING_AMOUNT() { return "lastBillingAmount"; }
  static function LAST_REASON_CODE() { return "lastReasonCode"; }
  ...
  static function REBILL_STATUS() { return "rebillStatus"; }
