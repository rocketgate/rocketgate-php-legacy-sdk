...
if ($service->PerformPurchase($request, $response)) {
  ...
  print "Account: " . $response->Get(GatewayResponse::MERCHANT_ACCOUNT()) . "\n";
	...
	//
      ...
      $request->Set(GatewayRequest::XSELL_MERCHANT_ID(), $merchant_id_1c);
	  ...
	  //  xsell can have different user/pass then primary
	  $request->Set(GatewayRequest::USERNAME(), "xsell_user"); 
	  $request->Set(GatewayRequest::CUSTOMER_PASSWORD(), "xsell_pass");
