...
$request->Set(GatewayRequest::MERCHANT_INVOICE_ID(), $time . '.CreditTest');
...
$request->Set(GatewayRequest::REFERRER_URL(), "https://local.rocketmerchant.com/php-sdk-legacy");
